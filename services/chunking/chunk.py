...
from utils.constants import ALL_EXTENSIONS
from services.chunking.dataclass.main import (
    ChunkMetadata,
...
from services.tiktoken import TikToken
...
def extract_name(node: Node, grammar: Dict[str, str]) -> Optional[str]:
    ...
    if (
            node.type
            in grammar[LanguageIdentifiers.FUNCTION_IDENTIFIER.value] + grammar[
