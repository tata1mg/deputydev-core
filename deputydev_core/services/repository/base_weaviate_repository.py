...
class BaseWeaviateRepository:
    def __init__(
        self, weaviate_client: WeaviateSyncAndAsyncClients, collection_name: str
    ):
    ...
    async def ensure_collection_connections(self) -> None:
        ...
        self.async_collection = self.weaviate_client.async_client.collections.get(
            self.collection_name
        )
        self.sync_collection = self.weaviate_client.sync_client.collections.get(
            self.collection_name
        )
