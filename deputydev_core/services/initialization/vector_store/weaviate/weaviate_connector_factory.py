...
from deputydev_core.services.initialization.vector_store.weaviate.weaviate_connector import DarwinWeaviateConnector, LinuxWeaviateConnector, WindowsWeaviateConnector
...
class WeaviateConnectorFactory:
    ...
    @classmethod
    def get_compatible_connector(cls) -> Type[Union[DarwinWeaviateConnector, LinuxWeaviateConnector, WindowsWeaviateConnector]]:
