...
from deputydev_core.services.batch_chunk_search.dataclass.main import ChunkDetails, ChunkInfoAndHash, FocusChunksParams, CodeSnippetDetails
...
from deputydev_core.utils.weaviate import weaviate_connection, initialise_weaviate_client
...
class RelevantChunksService:
    ...
    async def get_relevant_chunks(
        self, payload: RelevantChunksParams, one_dev_client, embedding_manager, initialization_manager, process_executor
    ) -> Dict[str, Any]:
